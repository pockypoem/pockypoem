...
### Tech Stacks
![My Skills](https://skillicons.dev/icons?i=html,css,js,ts,cs,dotnet,react,jest,vitest,php,py,flask,nodejs,express,java,postgres,mongodb,mysql,bootstrap,tailwind,tensorflow,laravel,git,github,vite,netlify,vscode,visualstudio,idea,postman,discord&theme=light)
### 📈 Github Stats
